...
<head>
    ...
    <script src="js/ie-emulation-modes-warning.js"></script><html>
		...
		<div class="container">
			...
			<table style="border:1px solid;border-color:#ff8800" border='1' width='40%'>
			...
			echo '<td style="margin-right:15px"><a href="./suc.php?slotid='.$slotData[$i]['slot_id'].'"><button type="submit1" name="slotid"  class="btn btn-default btn btn-xs btn-success pull-right" style="margin-right:10px; margin-bottom:20px" >Manage</a></button></td>';
