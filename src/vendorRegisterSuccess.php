...
<head>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h3>Successfully Registered your Charging station</h3>
        <p class="lead">
		<?php
		$info = explode(":",$register);
		echo 'You have successfully registered '.$info[2].' slots at '.$info[1].", ".$info[0]; 
		?>
		</p>
      <footer class="footer">
