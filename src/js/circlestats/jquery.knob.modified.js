    ...
    $.fn.knob = $.fn.dial = function (gopt) {
        ...
        return this.each(
            ...
            function () {
                ...
                var lenth = parseInt($this.val().length)>3?$this.val().length:0;
                var lenths= parseInt($this.val().length)>4?$this.val().length:0;
                var c = $('<canvas width="' + (opt.width) + '" height="' + opt.width + '"></canvas>')
                    ...
                    ,initStyle = function () {
                        opt.displayInput
                        && $this.css({
                                    'width' : (opt.width/2+(lenth*4)) + 'px'
                                    ,'position' : 'absolute'
                                    ,'margin-top' : (opt.width * 5 / 14) + 'px'
                                    ,'margin-left' : '-' + ((opt.width*3/4)+lenth*2) + 'px'
                                    ,'font-size' : (opt.width / 4-(lenths)) + 'px'
                                    ,'border' : 'none'
                                    ,'background' : 'none'
                                    ,'font-family' : 'Arial'                                  
                                    ,'font-weight' : 'bold'
