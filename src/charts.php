...
<div class="container">
      ...
      <div class="jumbotron">
		  <div class="row" style="margin-top:-20px;">
			  <div class="col-md-6" style="padding:5px;"><h5>Revenue Stats</h5><div id="container"></div></div>
			  <div class="col-md-6"style="padding:5px;"><h5>Vehicle Stats</h5><div id="container2"></div></div>
		  </div>
	  </div>
 <footer class="footer">
